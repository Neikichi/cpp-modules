...
int main()
{
	...
	std::cout << "\n===Intern forms===\n";
	Intern intern;
	AForm* srf = intern.makeForm("ShrubberyCreationForm", "Novice");
	AForm* rrf = intern.makeForm("RobotomyRequestForm", "Mage");
	AForm* prf = intern.makeForm("PresidentialPardonForm", "HighWizard");

	AForm* xrf = intern.makeForm("RagnarokOnline", "HighWizard");
	AForm* prrf = intern.makeForm("Shrubbery", "Novice");
	AForm* prrf2 = intern.makeForm("Form", "Novice");
